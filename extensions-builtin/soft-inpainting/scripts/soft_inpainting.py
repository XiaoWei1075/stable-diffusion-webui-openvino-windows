...
class Script(scripts.Script):
    ...
    def on_mask_blend(self, p, mba, enabled, power, scale, detail_preservation, mask_inf,
    ...
    def post_sample(self, p, ps, enabled, power, scale, detail_preservation, mask_inf,
                    dif_thresh, dif_contr):
        if not enabled:
            return
