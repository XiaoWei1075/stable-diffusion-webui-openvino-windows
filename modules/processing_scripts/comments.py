...
def before_token_counter(params):
    if not shared.opts.enable_prompt_comments:
        return
...
if hasattr(script_callbacks, "on_before_token_counter"):
    script_callbacks.on_before_token_counter(before_token_counter)


shared.options_templates.update(shared.options_section(('sd', "Stable Diffusion"), {
